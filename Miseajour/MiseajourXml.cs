...
namespace Miseajour
{
    internal class MiseajourXml
    {
        ...
        internal MiseajourXml(Version version, Uri uri, string fileName, string md5, string description, string launchArgs)
        {
        ...
        internal static MiseajourXml Parse (Uri location, string appID)
        {
            ...
            try
            {
                ServicePointManager.ServerCertificateValidationCallback = (c, ce, ch, ss1) => true;
                ...
                return new MiseajourXml(version, new Uri(url), fileName, md5, description, launchArgs);
            }
            catch { return null;  }
        }
    }
